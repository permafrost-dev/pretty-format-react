...
export const serialize: NewPlugin['serialize'] = (
    ...
    ++depth > config.maxDepth
        ...
        : printElement(
              object.type,
              object.props ? printProps(getPropKeys(object), object.props, config, indentation + config.indent, depth, refs, printer) : '',
              object.children ? printChildren(object.children, config, indentation + config.indent, depth, refs, printer) : '',
              config,
              indentation,
          );

export const test: NewPlugin['test'] = val => val && val.$$typeof === testSymbol;
