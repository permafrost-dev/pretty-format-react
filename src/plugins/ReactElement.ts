...
export const serialize: NewPlugin['serialize'] = (
    ...
    ++depth > config.maxDepth
        ...
        : printElement(
              ...
              printChildren(getChildren(element.props.children), config, indentation + config.indent, depth, refs, printer),
              config,
              indentation,
          );

export const test: NewPlugin['test'] = (val: unknown) => val != null && ReactIs.isElement(val);
