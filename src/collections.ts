...
const getKeysOfEnumerableProperties = (object: Record<string, unknown>, compareKeys: CompareKeys) => {
    const rawKeys = Object.keys(object);
    const keys: Array<string | symbol> = compareKeys !== null ? rawKeys.sort(compareKeys) : rawKeys;
